...
if($_GET){
	$id_anuncio=$_GET['id'];
	$id_vendedor=1;
	echo "<center>Aqui se detalla el producto</center>";
	/* AQUI SE DETALLA EL PRODUCTO*/
	if($_SESSION){
		echo "<div style=\"width:940px;\" >";
		echo "Contactar con el Administrador<div style=\"min-height:1px; clear:both; width:100%; border-bottom:1px solid #d1d1d1; height:1px; padding-top:5px; margin-top:5px; margin-bottom:10px;\"></div>";						
